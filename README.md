...
Agent Card discovery, the required `SendMessage`, `GetTask`, and `CancelTask`
operations, optional `ListTasks`, explicit `A2A-Version: 1.0` negotiation,
caller-bound task storage, and AbsoluteJS Agency enforcement.
